...
/**
 @constructor
 @classdesc FFGeoLocation have (at least) the following fields:
 <ul>
 <li><strong>clazz</strong> - always == 'FFGeoLocation' - maps to the FatFractal OBJECTTYPE
 <li><strong>latitude</strong>
 <li><strong>longitude</strong>
 <li><strong>altitude</strong>
 <li><strong>accuracy</strong>
 <li><strong>altitudeAccuracy</strong>
 <li><strong>heading</strong>
 <li><strong>speed</strong>
 </ul>
 */
function FFGeoLocation(g) {
    ...
    if(g) {
        ...
        this.altitudeAccuracy = g.altitudeAccuracy;
